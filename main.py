...
# this is the language code in which echo speaks i.e hi = hindi , eng-in = english(india)
...
def wishme():
    ...
    speech.ttspeech(
        "नमस्ते मैं इको  हूँ मैं आपकी मदद कैसे कर सकती हूँ ", lang2)
    # speech.ttspeech("hi i am echo your virtual assistant..HOW MAY i HELP YOU sir", lang1)
...
# image download from google functions starts from here
